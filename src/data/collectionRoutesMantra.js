export const COLLECTION_ROUTES_MANTRA = Object.freeze({
  ...
  highlights: [
    ...
    },
    {
      ...
      text: "Před startem backend znovu ověří přihlášeného řidiče, datum a vozidlo vlastní trasy. Příprava, intro gong a agentův úvod běží v hologramu s aktivním mikrofonem, aby šlo Šarlotě ihned skočit do řeči. Přerušení okamžitě zruší zbytek zvuku i časovač. Po jediné závěrečné otázce KSO pět sekund čeká bez velkého mikrofonního panelu; bez řeči zazní outro gong a hologram se zavře. Každý provozní zápis dál vyžaduje fyzické potvrzení."
    }
  ],
  sources: [
