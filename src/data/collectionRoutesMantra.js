export const COLLECTION_ROUTES_MANTRA = Object.freeze({
  ...
  highlights: [
    ...
    },
    {
      ...
      text: "Před startem backend znovu ověří přihlášeného řidiče, datum a vozidlo vlastní trasy. Příprava, intro gong a agentův úvod běží bez mikrofonu výhradně v hologramu. Po jediné závěrečné otázce se ve stejné relaci zapne pětisekundový poslech bez velkého mikrofonního panelu. První řeč řidiče limit zruší a rozhovor může pokračovat libovolně dlouho; bez řeči zazní outro gong a hologram se zavře. Každý provozní zápis dál vyžaduje fyzické potvrzení."
    }
  ],
  sources: [
