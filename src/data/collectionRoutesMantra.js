export const COLLECTION_ROUTES_MANTRA = Object.freeze({
  version: "1.40",
  updatedAt: "20. 7. 2026 14:30",
  updatedAtIso: "2026-07-20T14:30:00+02:00",
  lastChange: "Jednorázový úvod, gongy a čekání",
  updatedBy: "Codex",
...
Když automaticky spuštěná Šarlota přehrává úvod, Řidičský displej místo technického obrazu mikrofonu ukáže kompaktní holografickou Šarlotu. Po závěrečné otázce mikrofon pět sekund poslouchá. Jakmile řidič promluví, úvodní timeout se zruší a pokračuje běžná hlasová komunikace bez dalšího gongu. Když nepromluví, KSO potlačí jakékoli samovolné dotazy agenta, přehraje dodaný outro gong a ukončí hologram, hlasovou relaci i mikrofon. Hologram nezakrývá navigaci. Novou ruční relaci otevře jen fyzické ZAPNOUT ŠARLOTU MIKROFONEM; začne otázkou ve významu „Mirku, s čím mohu pomoct?“ a potom poslouchá. Technický intro_announcement není slyšitelným textem. TEST se nesmí připojit, pokud skutečný ElevenLabs agent nemá ověřený Prompt, First Message, Knowledge Base, Tools nebo odpovídající modulový kontext.

Řidič potvrzuje převzetí dnešní trasy a volbu pracovní paměti v jednom okně a jedním finálním klepnutím. Okno předem ukazuje backendem ověřeného řidiče, vozidlo, počet stanovišť, pravdivý stav osádky a počasí pro následující směnu. Těsně před zápisem backend znovu ověří vlastní přiřazení, datum a vozidlo; rozpor start zablokuje. Neznámý údaj zůstává viditelným varováním a nesmí se nahradit odhadem. Pokud paměť výslovně nezaškrtne, nezapne se ani se nic neuloží. Potom se v témže uživatelském gestu připraví zvuk i mikrofon, načte read-only kontext a jednorázově zazní intro gong a agentem vytvořený úvod. Po závěrečné otázce běží přesně pětisekundové čekání: odpověď otevře běžný rozhovor, ticho vyvolá outro gong a ukončení. Výzva Jste stále zde ani jiná samovolná věta není dovolena. Pokud kontext, mikrofon, signed URL, WebSocket, validace nebo audio selže, tablet zobrazí pravdivou chybu a nesmí použít systémové TTS ani předstírat přehrání.
