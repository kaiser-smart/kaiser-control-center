export const COLLECTION_ROUTES_MANTRA = Object.freeze({
  ...
  highlights: [
    ...
    },
    {
      ...
      text: "Před startem backend znovu ověří přihlášeného řidiče, datum a vozidlo vlastní trasy. Po fyzickém potvrzení vytvoří aktivní ElevenLabs agent přesně jedno krátké přivítání z Promptu, Knowledge Base a ověřeného kontextu. Po dohrání úvodu se Šarlota i mikrofon automaticky vypnou. Ruční zapnutí mikrofonem zahájí novou relaci krátkou otázkou s ověřeným oslovením. Každý provozní zápis dál vyžaduje fyzické potvrzení."
    }
  ],
  sources: [
