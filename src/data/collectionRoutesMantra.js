export const COLLECTION_ROUTES_MANTRA = Object.freeze({
  ...
  lastChange: "Živý Prompt a KB tabletu",
  updatedBy: "Codex",
...
Hlasová Šarlota je samostatná přátelská konverzační asistentka. Po fyzickém potvrzení dnešní trasy nesmí přečíst pevnou backendovou šablonu. Backend předá pouze technický marker a strukturovaný ověřený kontext; KSO technickou First Message umlčí a vyžádá si skutečné úvodní hlášení od aktivního ElevenLabs agenta. Slyšitelné přivítání proto vytváří LLM podle skutečně aktivního Promptu, připojené Knowledge Base, Tools a dynamic variables modulu Svozové trasy. Musí být krátké, nesmí opakovat název trasy nebo vozidlo různými větami, přirozeně dá najevo, že lze vyrazit, a na potvrzení trasy se znovu neptá. Oslovuje jen osoby skutečně potvrzené backendem a nesmí si domýšlet posádku, vozidlo, počasí ani paměť.
