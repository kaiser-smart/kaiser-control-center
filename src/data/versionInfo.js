...
export const versionInfo = {
  ...
  version: valueOrUnknown(buildMeta.version, "v0.1.813"),
  status: "development",
...
export const versionNews = [
  {
    title: "Forpsi: podpisy a nové koncepty",
    text: "Podpis a jméno odesílatele mají vlastní nastavení v SO.ai. Pošta připraví textový náhled a po povolení ukládání a ověření práv vytvoří nový koncept ve Forpsi. Odesílání není součástí této etapy."
  },
  {
    title: "Forpsi: přehlednější nastavení",
    text: "Schránky, přístupy kolegů a vstup do Pošty jsou po ruce. Služby, speciální složky, přehled pravidel a log jsou v rozbalovacích částech. Rozpracované změny zůstávají chráněné."
  },
  {
  ...
  {
    title: "Forpsi: výběr skutečných složek a dostupné služby",
    text: "Nastavení načte složky, kalendáře a adresáře přímo z Forpsi. Složky pro zprávy se vybírají z ověřeného seznamu; stav každé služby je vidět samostatně. Schránka po uložení zůstává pozastavená do nového ověření."
  },
  {
  ...
  {
    title: "Vistos faktury: navazující synchronizace změn",
    text: "Počáteční import pokračuje po dávkách na serveru. Další synchronizace aktualizují uložené faktury podle ID a data změny; otevření stránky již nezakládá nový úplný import. V detailu zákazníka lze procházet všechny faktury pomocí stránkování."
  },
  {
  ...
  },
  {
    ...
    text: "Volba Pamatuj si mě na 30 dní prodlouží nové přihlášení na 30 dní. Bez zaškrtnutí zůstává platnost 12 hodin."
  },
  {
    title: "Datové schránky: jasný výsledek testu připojení",
    text: "Výsledek zůstává přímo u schránky s časem testu. Chybné ID, odmítnutý login nebo heslo, oprávnění a výpadek služby mají vlastní vysvětlení. Test rozlišuje ověřené přihlášení od neověřené shody ID."
  },
  {
  ...
  {
    title: "Vistos → LeadHub: CSV pro celý zbývající výběr",
    text: "Koordinátor umí rezervovat celý bezpečný historický zbytek bez omezení na pilotní dávku. Kontroly pokračují v krátkých uložených blocích, před vytvořením souboru se zopakuje úplné porovnání identit a ověří návaznost delty. Každý importovaný profil se samostatně ověří a převezme do stejné evidence. Příprava CSV není dokončený import; odběry ani zprávy se nezapínají."
  },
  {
    title: "Vistos → LeadHub: obnovení přerušeného čtení před CSV",
    text: "Výslovně určený starý běh s úplně prázdným deníkem lze bezpečně uzavřít bez opakování zápisů. Neověřené staré CSV položky zůstávají v samostatné karanténě; ostatní dávky mohou pokračovat pod stejným koordinátorem. Odběry, blokace a zákaz zpráv se nemění."
  },
  {
    title: "Vistos → LeadHub: krátké čtecí bloky CSV",
    text: "Příprava a převzetí CSV ověří v jednom krátkém běhu více nezávislých řádků. Limity API i kontrola každé identity, odběrů a blokací zůstávají beze změny; chybějící výsledek neblokuje čtení ostatních položek a nikdy se nepovažuje za úspěch."
  },
  {
  ...
  {
    title: "Vistos → LeadHub: odmítnutá položka neblokuje bezpečnou frontu",
    text: "Odmítnutí prvního čtení nového profilu HTTP 422 se eviduje jako samostatný SKIP bez zápisu. Stejná zdrojová verze se při dalších bězích znovu nezkouší. Již synchronizované profily, rozpracované zápisy, odběry a blokace si zachovávají všechny ochrany."
  },
  {
    title: "Vistos → LeadHub: oddělení pomalé přípravy od zápisů",
    text: "Dohánění delty po delší odstávce nejdříve bezpečně uloží zdroj a frontu. Pokud příprava spotřebuje časové okno, předá zápisy dalšímu běhu místo jejich zahajování těsně před limitem HTTP. Zápisy i zpětné kontroly zůstávají pod stejným koordinátorem."
  },
  {
    title: "Vistos → LeadHub: obnova dokončené dávky se zbylým zámkem",
    text: "Po přerušení závěrečného úklidu se celá uložená dávka ověří proti deníku, evidenci i aktuálním profilům, odběrům a blokacím. Teprve úplně potvrzená dávka uvolní zámek bez opakování zápisů nebo změny checkpointu. Nejasné operace zůstávají chráněné; zprávy se neodesílají."
  },
  {
    title: "Vistos → LeadHub: řízené využití kapacity API",
    text: "Odstupy požadavků odpovídají konkrétním endpointům a neopakují již uplynulé čekání. Společný zapisovatel postupně zvyšuje souběh nezávislých profilů podle potvrzených výsledků a při chybách nebo vyšší latenci zpomalí. Každý zápis nadále ověřuje identitu, odběry, blokace i výsledek; žádné zprávy neodesílá. Dokončení importu se vykazuje skutečnými počty, nikoli nastaveným souběhem."
  },
  {
    title: "Vistos → LeadHub: bez zbytečné kontroly kampaní při NO_CHANGE",
    text: "Pokud aktuální profil, identita a výsledný integrační tag souhlasí, běh pouze ověří odběry a blokace a nic nezapisuje. Teprve skutečná změna vyžaduje kontrolu kampaní. Bezpečnost zápisů, evidence operací i dosavadní fronta zůstávají beze změny."
  },
  {
  ...
  },
  {
    ...
    text: "Urgentní vyřazení zůstávají první. Delta, historie a běžné obchodní vazby střídají kapacitu podle trvale uloženého pořadí. Také historie střídá zakládání a bezpečné propojení existujících profilů. Diagnostika odlišuje dokončené unikátní profily od opakovaných aktualizací a měří jednotlivé fáze i stáří fronty."
  },
  {
    title: "Vistos → LeadHub: trvalé pokračování importu",
    text: "Serverový plánovač navazuje na uložené operace a zachovává přednost delty. Jednoznačné existující profily se propojují bez přepsání user_id; vazby smluv doplňuje ověřený detail. Dokončení importu a členství publik se posuzuje podle skutečného zpětného čtení, nikoli podle nasazení."
  },
  {
    title: "Vistos → LeadHub: samostatné ověření obchodních vazeb",
    text: "Krátké čtecí bloky ověřují dvě úplné množiny smluv, nabídek a objednávek. Přímé a firemní vazby jsou oddělené; chybějící nebo nestabilní data zůstávají NEOVĚŘENO. Faktury ani servisní listy se nepoužívají."
  },
  {
    title: "Vistos → LeadHub: přednost změn a ověření nových identit",
    text: "Vyřazení a změny již synchronizovaných profilů mají přednost před historií. Nové kontakty čekají na úplný export identit LeadHubu; kolize se nepřepisují ani neslučují. Odběry a zprávy zůstávají zakázané."
  },
  {
    title: "Vistos → LeadHub: bezpečná obnova přerušené dávky",
    text: "Obnova ověřuje i již dokončené operace, ale nezapočítává je podruhé. Historický import zpracuje nejvýše jeden profil na běh. Odběry a blokace se kontrolují zpětným čtením; žádné zprávy se neodesílají."
  },
  {
    title: "Vistos → LeadHub: bloková příprava aktuálního manifestu",
    text: "Jednorázová serverová příprava zaznamená začátek a konec Contact snímku, ověří úplnost ID a změny během načítání. Použije existující DNS výsledky a úplný LeadHub export. Zatím neimportuje profily ani neposouvá produkční checkpoint."
  },
  {
    title: "Vistos → LeadHub: kontrola automatických zpráv před zápisem",
    text: "Zápis profilu vyžaduje úplné serverové čtení kampaní. Aktivní, naplánovaná nebo neověřená zprávová kampaň jej zastaví; existující popup se nemění. Bez ověřeného přístupu se import nespustí."
  },
  {
    title: "Vistos → LeadHub: oddělené ověření síťového spojení a účtu",
    text: "Chráněná čtecí kontrola rozlišuje chybnou konfiguraci Vistosu, dostupnost serveru, přihlášení a skutečný LeadHub workspace. Hodnoty secretů, zákaznická data ani produkční checkpoint nemění."
  },
  {
  ...
  {
    title: "Vistos → LeadHub: bezpečný kompaktní checkpoint",
    text: "První plánovaný běh umí převzít předem připravený chráněný Contact/DNS snapshot bez načtení velkého auditu do paměti. Stále vytvoří jen checkpoint, ověří READ scopes a neimportuje žádný historický profil."
  },
  {
  ...
  {
    title: "Vistos kontakty: oslovení oddělené od datové kvality",
    text: "Kontakt s použitelným FirstName nebo LastName už není vyřazen jen proto, že české oslovení vyžaduje kontrolu. SALUTATION_READY, SALUTATION_REVIEW a SALUTATION_MISSING zůstávají samostatným atributem; všechny ostatní bezpečnostní filtry, import i komunikace zůstávají beze změny."
  },
  {
  ...
  {
    title: "Zprávy RCS a SMS: funkční editor a příjem zpráv",
    text: "Editor umožňuje bezpečně napsat další ruční odpověď i bez nového návrhu Šarloty. Příchozí webhook ověřuje podpis proti všem nakonfigurovaným Twilio účtovým tokenům a Nastavení viditelně potvrzuje zapojení OpenAI."
  },
  {
  ...
  {
    title: "RCS/SMS: ručně potvrzená odpověď při globálním off",
    text: "Jednorázově schválená odpověď používá vlastní úzkou serverovou cestu navázanou na spotřebovaný review grant. Obecné zákaznické odesílání, automatický outbound, nástroje a retry zůstávají vypnuté; bez samostatného fyzického potvrzení se nic neodešle."
  },
  {
    title: "RCS/SMS příjem: Twilio-kompatibilní ověření webhooku",
    text: "Příchozí RCS a SMS callbacky ověřují přesné hodnoty formuláře, opakované parametry, oficiální URL varianty a JSON body hash bez oslabení podpisu. Neplatný podpis zůstává odmítnutý; zákaznické odesílání se touto opravou nezapíná."
  },
  {
  ...
  {
    title: "RCS test: oslovení podle příjemce",
    text: "Ruční test RCS šablony v Nastavení už neposílá ukázkové oslovení Radime automaticky. Před odesláním dohledá telefon v Uživatelích/Zaměstnancích, dosadí ověřené oslovení jako Petře nebo Jarko a bez dohledání či ručního oslovení test zastaví."
  },
  {
  ...
  {
    title: "Připomínky a chyby: lidské názvy i u starších případů",
    text: "Starší případy používají v uživatelském přehledu jednotný název Připomínky a chyby. Technické názvy interních produkčních testů se běžnému uživateli nezobrazují; správce si zachovává původní interní evidenci."
  },
  {
  ...
  {
    title: "Datové schránky: viditelný náhled PDF příloh",
    text: "Každá PDF příloha má v detailu zprávy samostatné výrazné tlačítko Otevřít náhled. Tlačítko zůstává dobře viditelné na desktopu, tabletu i mobilu a nesplývá s názvem souboru."
  },
  {
