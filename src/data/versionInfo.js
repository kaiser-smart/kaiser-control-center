...
export const versionInfo = {
  ...
  version: valueOrUnknown(buildMeta.version, "v0.1.428"),
  status: "development",
...
export const versionNews = [
  {
    title: "Trasy svozu: API refresh Stanovišť",
    text: "Odpočet ve Stanovištích teď jasně ukazuje další read-only API kontrolu a umožňuje ručně spustit volání API hned."
  },
  {
    title: "Trasy svozu: zákaznický manažer z Vistosu",
    text: "Stanoviště z Vistosu umí do detailu převzít zákaznického manažera včetně mobilu a e-mailu, pokud jsou pole dostupná ve Vistos metadatech."
  },
  {
  ...
  {
    title: "Trasy svozu: detail Adresního místa z Vistosu",
    text: "Read-only snapshot Stanovišť si pro Svoz Kaiser řádky dočítá detail položky smlouvy z Vistosu, aby Smart zobrazil stejné Adresní místo jako formulář Vistos."
  },
  {
  ...
  },
  {
    ...
    text: "Vistos Svoz Kaiser parser převádí číselníkové ID svozového dne 18330-18343 na čitelné dny sudého/lichého týdne, zvládá i více dnů v jednom poli a zákaznický caption typu s.r.o. - IČO už nebere jako Adresní místo ani jako srovnávací adresu."
  },
  {
  ...
  {
    title: "Manuály modulů",
    text: "Do příručky projektu přibylo pravidlo, že hlavní moduly mají mít praktický uživatelský manuál v aplikaci i jako PDF. První pilotní manuál je vložený do modulu Hlášení řidičů."
  },
  {
  ...
  {
    title: "Trasy svozu: doplnění Vistos kontaktů",
    text: "Vistos Svoz Kaiser snapshot nově read-only načítá nepovinné Stanoviště a kontakt na zákaznického manažera: mobil a e-mail. Údaje se zobrazují v detailu položek smlouvy a jejich absence není blokující chyba."
  },
  {
  ...
  {
    title: "Pohledávky: rychlý verdikt Vistos readiness",
    text: "Importní stránka Pohledávek má nad technickou diagnostikou krátký manažerský verdikt: zda zůstat jen v preview, co blokuje rating/import a co řešit jako první. Nemění API, D1, rating, KB platby ani zákaznickou komunikaci."
  },
  {
  ...
  {
    title: "Pohledávky: detail firem podle Vistos ID",
    text: "Read-only ledger readiness nově bere Customer_FK a CustomerBranch_FK ze smluv a faktur a zkouší k nim Vistos GetByIdParam. UI ukazuje Detail firem podle Vistos ID včetně nejlepší entity, vrácených detailů a použitelných polí. Bez D1 zápisu, ratingu, KB plateb a komunikace zákazníkům."
  },
  {
