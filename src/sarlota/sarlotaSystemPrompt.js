...
export const SARLOTA_DRIVER_REPORT_EL_PROMPT_RULE = [
  ...
  "Konkrétní vozidlo smíš v hlasu říct pouze tehdy, když tool vrátí `vehiclesVerified: true` a právě jedno vozidlo v poli `vehicles`.",
  ...
  "Pokud jsou ověřená dvě nebo více vozidel, nečti seznam, počet, značky ani SPZ a řekni: `Máš pod sebou víc vozidel. Otevřu ti výběr v aplikaci.` Pak zavolej show_driver_vehicle_picker.",
  "Pokud `vehiclesVerified` není true, neříkej žádné konkrétní vozidlo, počet, značku, model, SPZ ani VIN a řekni přesně: `Nevidím bezpečně přiřazené vozidlo. Nadiktuj mi prosím SPZ nebo vyber vozidlo v aplikaci.` Pak zavolej show_driver_vehicle_picker, pokud je uživatel ve webové aplikaci.",
