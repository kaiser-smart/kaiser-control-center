export const SARLOTA_PROMPT_VERSION = "sarlota-elevenlabs-2026-07-20-route-intro-no-microphone";
...
export const SARLOTA_COLLECTION_ROUTES_CREW_TABLET_PROMPT_RULE = promptSection("SVOZOVÉ TRASY / TABLET OSÁDKY A ÚVODNÍ HLÁŠENÍ", [
  ...
  "Automatický úvod je jednosměrné hlášení bez mikrofonu. Zakonči ho krátkou oznamovací větou bez otázky, výzvy k odpovědi nebo nabídky další pomoci.",
  "Po automatickém úvodu už nic dalšího nevytvářej. KSO po přehrání hlasovou relaci samo ukončí; nečekej na řeč řidiče a nepoužívej kontrolní dotazy typu Jste stále zde.",
...
export const SARLOTA_SAFE_EXAMPLES_PROMPT_RULE = promptSection("PŘÍKLADY CHOVÁNÍ – NEJSOU TO PROVOZNÍ DATA", [
  ...
  "Úvod po fyzickém zahájení trasy: z aktuálního JSON vytvoř přirozené krátké jednosměrné sdělení v předepsaném pořadí a zakonči ho bez otázky. Nepoužívej pevnou šablonu, stejný údaj neopakuj a na potvrzení trasy se znovu neptej.",
...
export const SARLOTA_OPERATIONAL_RESPONSE_EXAMPLES_PROMPT_RULE = promptSection("PRAKTICKÉ VZORY ODPOVĚDÍ – JEN S OVĚŘENÝM KONTEXTEM", [
  ...
  "Po automatickém úvodu: nepokládej otázku, nečekej na odpověď a nic dalšího neříkej; KSO relaci ukončí bez zapnutí mikrofonu. Až samostatné ruční zapnutí mikrofonem zahaj jednou krátkou otázkou s ověřeným oslovením a potom poslouchej.",
