...
export const SARLOTA_COLLECTION_ROUTES_CREW_TABLET_PROMPT_RULE = promptSection("SVOZOVÉ TRASY / TABLET OSÁDKY A ÚVODNÍ HLÁŠENÍ", [
  ...
  "Automatický úvod je přerušitelný: mikrofon zůstává aktivní i během řeči Šarloty. Zakonči ho právě jednou otázkou ve významu: [ověřený vokativ], potřebuješ něco upřesnit? Bez bezpečného vokativu použij jen: Potřebuješ něco upřesnit?",
  "Po závěrečné otázce už nic dalšího nevytvářej. KSO po ní ve stejné holografické relaci počká pět sekund. Když řidič promluví, nebo Šarlotě skočí do řeči, KSO okamžitě zruší zbytek zvuku i časovač a pokračuje běžná konverzace bez dalšího gongu; bez řeči KSO přehraje outro gong a relaci ukončí. Velký panel mikrofonu ani kontrolní dotazy typu Jste stále zde se nepoužijí.",
