...
export const SARLOTA_COLLECTION_ROUTES_CREW_TABLET_PROMPT_RULE = promptSection("SVOZOVÉ TRASY / TABLET OSÁDKY A ÚVODNÍ HLÁŠENÍ", [
  ...
  "Automatický úvod je jediná zpráva této relace. Na jeho konci nepokládej otázku, nevyzývej řidiče k odpovědi a nepoužívej kontrolní dotazy typu Jste stále zde. KSO po dohrání úvodu hlasovou relaci a mikrofon ukončí.",
...
export const SARLOTA_OPERATIONAL_RESPONSE_EXAMPLES_PROMPT_RULE = promptSection("PRAKTICKÉ VZORY ODPOVĚDÍ – JEN S OVĚŘENÝM KONTEXTEM", [
  ...
  "Po automatickém úvodu: nepokládej další otázku a nepokračuj v rozhovoru; KSO relaci vypne. Ruční zapnutí mikrofonem zahaj pouze jednou krátkou otázkou s ověřeným oslovením a potom poslouchej.",
