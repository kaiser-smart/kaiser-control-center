...
export const ROLE_DESCRIPTIONS = {
  ...
  ridic: "Uzamčený Řidičský displej s vlastní svozovou trasou a vlastními servisními hlášeními.",
...
const MODULE_ALIASES = {
  ...
  reporty: "reports",
  "rcs-sms-konverzace": "rcs-sms-autopilot",
  "rcs-sms-autopilot": "rcs-sms-autopilot",
  uzivatele: "users",
  nastaveni: "settings",
...
export const ROLE_PERMISSIONS = {
  ...
  kancelar: [
    ...
    ...actions("rcs-sms-autopilot", ["view", "manage", "export"]),
  ...
  garazmistr: [
    ...
    ...actions("reports", ["view", "export"]),
    ...actions("rcs-sms-autopilot", ["view"]),
  ...
  dispecer: [
    ...
    ...actions("rcs-sms-autopilot", ["view", "manage"]),
    ...actions("absence", ["view", "create", "approve"]),
    ...actions("feedback", ["view", "create"])
  ],
  ridic: [
...
export function hasPermission(user, moduleId, action = "view") {
  ...
  if (
    role === "ridic" &&
    normalizedModuleId === "driver-reports" &&
    ["view", "create"].includes(normalizedAction)
  ) {
    return true;
  }
