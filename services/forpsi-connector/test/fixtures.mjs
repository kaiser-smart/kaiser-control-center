...
export function fixture() {
  ...
  for (const name of ['0001_mail_connector.sql', '0002_labels_rules.sql', '0003_administration.sql', '0004_composition.sql', '0005_workflow.sql', '0006_onboarding.sql', '0007_personalized_setup.sql']) {
