...
function testFleetPayloadFromEnv(env = {}) {
  ...
  return {
    ...
    summary: payload.summary || fleetSummaryFromVehicles(vehicles),
...
function fleetVehicleFromVistos(vehicle = {}, tcarsVehicle = null) {
  ...
  return {
    ...
    euroNorm: cleanString(technicalProfile?.euroEmissionStandard?.caption),
    ...
    stkValidTo: cleanString(vehicle.stkValidTo),
    emissionsValidTo: cleanString(vehicle.emissionsValidTo),
    tachographValidTo: cleanString(vehicle.tachographValidTo),
    craneRevisionValidTo: cleanString(vehicle.craneRevisionValidTo),
    liftRevisionValidTo: cleanString(vehicle.liftRevisionValidTo),
    pressureEquipmentRevisionValidTo: cleanString(vehicle.pressureEquipmentRevisionValidTo),
    fireExtinguisherValidTo: cleanString(vehicle.fireExtinguisherValidTo),
    insuranceCompany: "",
    insurancePolicyNumber: "",
    insuranceValidTo: cleanString(vehicle.insuranceValidTo),
    highwayVignetteValidTo: cleanString(vehicle.highwayVignetteValidTo),
