...
const PROMPT_REQUIREMENTS = [
  ...
  ["Automatický úvod proběhne celý bez mikrofonu", "automatický úvod bez mikrofonu"],
  ["potřebuješ něco upřesnit?", "závěrečná otázka automatického úvodu"],
  ["KSO po jejím dohrání ve stejné holografické relaci samo zapne pětisekundový poslech", "první reakce řidiče ve stejném hologramu"],
  ["Když řidič promluví, KSO zruší časovač", "první řeč řidiče zruší časovač"],
  ["Velký panel mikrofonu se v automatickém toku nepoužije", "zákaz velkého mikrofonního panelu"],
