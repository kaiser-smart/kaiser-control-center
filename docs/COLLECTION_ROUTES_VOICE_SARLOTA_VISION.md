...
Automatické úvodní hlášení je po celou dobu holografický tok: příprava, intro gong a mluvení Šarloty proběhnou bez mikrofonu. Teprve po jediné závěrečné otázce se ve stejné relaci zapne pětisekundový poslech. Když řidič promluví, limit se zruší a rozhovor může pokračovat libovolně dlouho ve stejném hologramu; bez řeči zazní outro gong a hologram se zavře. Velký mikrofonní panel se nikdy nezobrazí. Přehrávač obou gongů musí být explicitně dostupný přes hlasový provider; automatická řeč bez potvrzeného intro gongu nesmí začít.
