...
4. Automatický úvod proběhne bez mikrofonu, skončí oznamovací větou bez otázky a po přehrání se hlasová relace sama ukončí. Běžný rozhovor se otevře až samostatným fyzickým tlačítkem mikrofonu.
