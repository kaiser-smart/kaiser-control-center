...
4. Automatický úvod proběhne bez mikrofonu a skončí jedinou otázkou, zda řidič potřebuje něco upřesnit. Hologram pět sekund čeká pouze na fyzické tlačítko mikrofonu; bez klepnutí zazní outro gong. Klepnutí otevře ruční relaci bez opakování otázky.
