...
runVisible("node", ["scripts/collection-routes-cloud-preparation.test.mjs"]);
...
runVisible("node", ["scripts/collection-route-here-optimization.test.mjs"]);
runVisible("node", ["scripts/collection-routes-here-map-image.test.mjs"]);
runVisible("node", ["scripts/collection-routes-test-gps.test.mjs"]);
runVisible("node", ["scripts/collection-routes-test-incidents.test.mjs"]);
runVisible("node", ["scripts/collection-routes-sarlota-voice.test.mjs"]);
