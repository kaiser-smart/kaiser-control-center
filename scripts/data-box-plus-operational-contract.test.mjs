...
assert.equal(DATA_BOX_PLUS_OPERATIONAL_CONTRACT.archive.appliesToAllCurrentAndFutureMailboxes, true);
assert.equal(DATA_BOX_PLUS_OPERATIONAL_CONTRACT.archive.paidDataVaultCancellationAutomatic, false);
