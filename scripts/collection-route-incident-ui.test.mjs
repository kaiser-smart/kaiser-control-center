...
for (const marker of [
  ...
  "collectionRouteIncidentNextStep",
  "collectionRouteIncidentQueueFocus",
  "collection-route-incident-overview",
  "collection-route-incident-filter-bar",
  "collection-route-incident-row__work",
  "Další pracovní krok",
...
for (const selector of [
  ...
  ".collection-route-incident-row__work",
  ".collection-route-incident-actions__label",
  ".collection-route-incident-drawer",
