...
assert.match(compactChatStyles, /\.ds-plus-chat-window__messages\s*\{[\s\S]*display:\s*flex/);
assert.match(compactChatStyles, /\.ds-plus-chat-window__messages\s*\{[\s\S]*flex-direction:\s*column/);
assert.match(compactChatStyles, /\.ds-plus-chat-window__messages\s*\{[\s\S]*align-items:\s*flex-start/);
